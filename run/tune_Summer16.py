...
JR = JetResolution('Spring16_25nsV6_MC') # Spring16_25nsV6_MC, Summer16_25nsV1_MC
...
r = run([DY_LO_16, Top_16, VVTo2L2Nu_16, WJets_16], sel, JR, outfile="results/tune_Summer16_test4")
