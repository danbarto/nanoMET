...
r = run([DoubleMuon_Run2017], sel, JR, outfile="results/tune_DoubleMuon_Run2017_FixEE2017_1p5_sumPt15_max9_EEveto_vetoEta_moreParams_v10", METPtVar="METFixEE2017_pt", METPhiVar="METFixEE2017_phi", maxN=5e5, vetoEtaRegion=(2.65,3.14), jetThreshold=15.)
