...
JR = JetResolution('Autumn18_V7_DATA')
...
r = run([DoubleMuon_Run2018], sel, JR, outfile="results/tune_DoubleMuon_Run2018_incl_1p5_sumPt25_max25_v19", maxN=3e5, METPtVar="MET_pt_nom", METPhiVar="MET_phi_nom", JetCollection="Jet_pt_nom", vetoEtaRegion=(10.,10.), jetThreshold=25.)

LL = r.getLL( [1.5, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5, 0., .5] )
